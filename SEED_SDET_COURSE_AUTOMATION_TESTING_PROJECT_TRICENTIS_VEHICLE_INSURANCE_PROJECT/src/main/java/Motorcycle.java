...
public class Motorcycle {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		driver.findElement(By
				.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/section[1]/div[3]/input[1]"))
				.sendKeys("125");
		driver.findElement(By.xpath("//input[@id='engineperformance']")).sendKeys("1205");
		LocalDate currentDate = LocalDate.now();
		DateTimeFormatter dateFormat = DateTimeFormatter.ofPattern("MM/dd/yyyy");
		String formattedDate = currentDate.format(dateFormat);
		WebElement inputField = driver.findElement(By.xpath(
				"/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/section[1]/div[5]/input[1]"));
		inputField.sendKeys(formattedDate);
		driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div/form/div/section[1]/div[6]/select/option[2]"))
				.click();
		driver.findElement(By.xpath("//*[@id=\"listprice\"]")).sendKeys("1255");
		driver.findElement(By.xpath("//input[@id='annualmileage']")).sendKeys("155");
		...
		if (price_per_year.contains("2,480.00") && onl_claim.contains("Submit") && claim_discount.contains("10")
